...
|------|---------------|-------------------|------|
| 版本号 | 1.7.5.2685.2222 | **1.7.9.2026.0613** | 大版本升级 |
| Laravel 版本 | 8.x（已停止维护） | **13.15.0** | +4 个大版本 |
| PHP 要求 | ^7.3 \|\| ^8.0 | **^8.5** | 最低版本提升 |
| 安全修复 | — | **50+ 项** | 全面安全加固 |
...
| 项目 | 上游 | 本项目 | 提升 |
|------|------|--------|------|
| Laravel | ^8.0 | **^13.0** | +4 个大版本，安全性大幅提升 |
| PHP | ^7.3 \|\| ^8.0 | **^8.5** | 性能提升 ~30%，安全性 |
